# mycode (Repo for NA class)

This is a repo for a Network Automation class I'm taking through work. This is just a template; expect unchanged examples and boilerplate text.
